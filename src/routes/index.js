...
export const agentRoutes = {
  routes: [
    { path: "/agent/dashboard", name: "Dashboard", icon: <DashboardFilled /> },
    {
      ...
      routes: [
        { path: "/agents/tickets/semua", name: "Semua" },
        { path: "/agents/tickets/diajukan", name: "Diajukan" },
        { path: "/agents/tickets/dikerjakan", name: "Dikerjakan" },
        { path: "/agents/tickets/selesai", name: "Selesai" },
      ],
    },
  ],
};
