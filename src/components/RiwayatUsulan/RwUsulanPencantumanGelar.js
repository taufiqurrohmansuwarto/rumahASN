    ...
    >
      ...
      >
        <Flex align="center" gap={8}>
          <CrownOutlined style={{ color: "#FF4500", fontSize: "18px" }} />
          <div>
            <Title
              level={5}
              style={{
            ...
            >
              🎓 Riwayat Usulan Pencantuman Gelar
            </Title>
            <Text
              style={{
                color: "#787C7E",
            ...
            >
              Daftar usulan pencantuman gelar yang telah diajukan
            </Text>
          </div>
        </Flex>

        <Tooltip title="Refresh data usulan pencantuman gelar">
          <Button
            type="text"
            icon={<ReloadOutlined />}
