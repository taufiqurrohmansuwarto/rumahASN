    ...
    >
      ...
      >
        <Flex align="center" gap={8}>
          <ClockCircleOutlined style={{ color: "#FF4500", fontSize: "18px" }} />
          <div>
            <Title
              level={5}
              style={{
            ...
            >
              ⏱️ Riwayat Usulan Penyesuaian Masa Kerja
            </Title>
            <Text
              style={{
                color: "#787C7E",
            ...
            >
              Daftar usulan penyesuaian masa kerja yang telah diajukan
            </Text>
          </div>
        </Flex>

        <Tooltip title="Refresh data usulan penyesuaian masa kerja">
          <Button
            type="text"
            icon={<ReloadOutlined />}
