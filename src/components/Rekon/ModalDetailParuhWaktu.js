...
const ModalDetailParuhWaktu = ({
  ...
  useEffect(() => {
    if (data && visible) {
      ...
      const isCensoredGaji = data?.gaji === "***";
      setIsCensored(isCensoredGaji);

      const gajiValue =
        data?.gaji || data?.detail?.usulan_data?.data?.gaji_pokok || "0";
      setUpah(isCensoredGaji ? "0" : gajiValue.toString());
            ...
            {isCensored ? (
              ...
              >
                <Stack spacing="xs" align="center">
                  <IconShieldLock size={32} style={{ color: "#856404" }} />
                  <Text size="sm" fw={600} c="#856404" align="center">
                    Anda Tidak Memiliki Akses
                  </Text>
                  <Text size="xs" c="#856404" align="center">
                    Anda tidak memiliki akses untuk melihat dan mengedit data
                    upah pegawai ini.
                  </Text>
                </Stack>
              </Paper>
        ...
        <Stack spacing="md">
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <Text size="xs" c="dimmed" style={{ marginTop: 8 }}>
              Masukkan kode OTP 6 digit dari akun fasilitator SIMASTER Anda
            </Text>
          </div>
