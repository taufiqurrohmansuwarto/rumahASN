  ...
  const statisticItems = [
    {
      ...
      borderColor: "#FF4500",
      iconBg: "#FF4500",
      description: "Total indikator konsistensi data yang dievaluasi",
    },
    {
      title: "Data Berbeda",
      ...
      >
        ...
        >
          ...
          <div style={{ flex: 1, textAlign: isMobile ? "center" : "left" }}>
            ...
            >
              🔄 Dimensi Consistency (Konsistensi Data)
            </Title>
            <Text
              style={{
            ...
            >
              Evaluasi keseragaman dan konsistensi data Pegawai ASN untuk
              memastikan keterpaduan informasi kepegawaian
            </Text>
          </div>
        </Flex>
      </Card>
        ...
        >
          ...
          <Flex align="center" gap={isMobile ? 10 : 12} wrap>
            ...
            <div style={{ flex: 1 }}>
              ...
              >
                Analisis mendalam untuk setiap parameter konsistensi data
              </Text>
            </div>
            <Badge
              count={data?.length || 0}
          ...
          >
            ...
            >
              Semakin konsisten data antar sistem, semakin reliable informasi
              yang dihasilkan. Klik &quot;Detail&quot; untuk melihat data
              spesifik yang perlu diseragamkan.
            </Text>
          </Alert>
