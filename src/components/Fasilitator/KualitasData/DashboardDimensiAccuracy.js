    ...
    >
      ...
      <div style={{ marginBottom: "32px" }}>
        ...
        <Text type="secondary" style={{ fontSize: "16px", lineHeight: "24px" }}>
          Monitoring dan analisis ketepatan data ASN untuk memastikan kualitas
          informasi
        </Text>
      </div>
      ...
      >
        <Space direction="vertical" size={24} style={{ width: "100%" }}>
          ...
          >
            Dimensi Accuracy mengukur ketepatan dan kebenaran data ASN. Semakin
            rendah nilai bermasalah, semakin baik kualitas data.
          </Alert>
