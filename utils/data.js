...
4.  BKD Provinsi Jawa Timur membuat Persetujuan Pindah ke instansi asal bagi PNS yang masuk ke Provinsi Jawa Timur.`,
  },
  {
    name: "Karis / Karsu",
    slug: "karis-karsu",
    content: `**PERSYARATAN KARIS / KARSU**
...
5. SFoto Copy SK Konversi NIP 18 (delapan belas) digit  
...
7. Surat Pengantar dari Badan Kepegawaian Daerah Provinsi Jawa Timur`,
  },
  {
    name: "Satya Lencana",
    slug: "satya-lencana",
...
1. Surat Keputusan (SK) pengangkatan sebagai CPNS, dan SK PNS bagai pegawai yang alih status  
kepegawaian  
2. Surat Keputusan Pangkat dan jabatan terakhir  
3. Surat Keterangan Tidak Pernah Dijatuhi Hukuman Disiplin Tingkat Sedang dan Berat dari  
...
Satyalencana Karya Satya bentuk lama, apabila telah memiliki`,
  },
  {
    ...
    slug: "ujian-dinas",
    content: `
**Pedoman Ujian Dinas**  [(Download)](https://bkd.jatimprov.go.id/layanan/PEDOMAN_UDIN.pdf)

**Lampiran Ujian Dinas**  [(Download)](https://bkd.jatimprov.go.id/layanan/UJIAN_DINAS.rar)
...
5. Menduduki jabatan fungsional tertentu / khusus`,
  ...
  {
    name: "Ujian Penyesuaian Ijazah",
    slug: "ujian-penyesuaian-ijazah",
    content: `
**Formasi KPPI:**  ([Download](https://bkd.jatimprov.go.id/berita-954-surat-penetapan-formasi-kppi-di-lingkungan-pemerintah-provinsi-jawa-timur.html#.XIdQQygzZPY))  
  
Dasar Ujian Kenaikan Pangkat Penyetaraan Ijazah :  **Pergub 71 Tahun 2011**  [(Download)](https://bkd.jatimprov.go.id/layanan/PERGUB_71_2011.pdf)

**Pedoman Ujian Kenaikan Pangkat Penyetaraan Ijazah** [(Download)](https://bkd.jatimprov.go.id/layanan/PEDOMAN_UKPPI.pdf)

**Lampiran Ujian Kenaikan Pangkat Penyetaraan Ijazah**  [(Download)](https://bkd.jatimprov.go.id/layanan/Form_UKPPI.rar)

**Pedoman Pembuatan Karya Tulis**  [(Download)](https://bkd.jatimprov.go.id/layanan/PEDOMAN_PEMBUATAN_KARYA_TULIS.pdf)
...
1. Sekurang-kurangnya telah 1 (satu) tahun pada pangkat terakhir, yaitu :  
	1. Minimal Juru golongan ruang I/c, untuk calon peserta yang mengajukan kenaikan pangkat pilihan dengan ijazah SLTA atau ijazah Diploma I atau ijazah lain yang setingkat ;

	2. Minimal Pengatur Muda Tingkat I golongan ruang II/b, untuk calon peserta yang mengajukan kenaikan pangkat pilihan dengan Ijazah Sarjana Muda, Ijazah Akademi, atau Ijazah Diploma III ;

	3. Minimal Pengatur golongan ruang II/c, untuk calon peserta yang mengajukan kenaikan pangkat pilihan dengan Ijazah Sarjana (S1), atau Ijazah Diploma IV ;  
	4. Minimal Penata Muda golongan ruang III/a ke bawah, untuk calon peserta yang mengajukan kenaikan pangkat pilihan dengan Ijazah Dokter, Ijazah Apoteker dan Ijazah Magister (S2) ;  
...
5. Pas Foto berwarna ukuran 3x4 dan 2x3 sebanyak 2 lembar dengan latar belakang warna merah dan menggunakan pakaian dinas ;  
...
2.  **Kenaikan Pangkat Funsional Tertentu**

-   SK Pangkat terakhir;
-   SKP Capaian SKP (Penilaian Prestasi Kerja 2 Tahun terakhir sekurang-kurangnya bernilai baik);
-   Penilan Angka Kredit( PAK)
...
3.  **Kenaikan Pangkat Struktural / Pilihan**
...
4.  BKD Provinsi Jawa Timur membuat Persetujuan Pindah ke instansi asal bagi PNS yang masuk ke Provinsi Jawa Timur.`,
  },
  {
    name: "PMK PNS",
    slug: "pmk-pns",
    content: `### Persyaratan Peninajauan Masa Kerja Pegawai Negeri Sipil
...
8.  Masa kerja yang diperhitungkan sebelum diangkat sebagai PNS adalah masa kerja dengan Ijazah minimum persyaratan Ijazah sesuai dengan peraturan perundang-undangan yang berlaku. Contoh :
						1.  Jabatan Fungsional Guru memiliki persyaratan berijazah paaling rendah S-1/D-IV untuk pengangkatan pertama dalam Jabatan, sehingga masa kerja sebelum PNS yang dihitung adalah masa kerja profesi guru berijazah S-1/D-IV.
						2. Jabatan Fungsional Dosen minimal S-2.
						3. Jabatan Fungsional Tenaga Kesehatan minimal D-3
10.  Pengajuan peninjauan masa kerja maksimal 10 (sepuluh) tahun sejak diangkat menjadi PNS
11.  Surat Pengantar dari Instansi
12.  Batas waktu untuk melengkapi berkas tidak lengkap adalah 30 (tiga puluh) Hari Kalender sejak notifikasi BTL`,
  },
  {
    name: "Karpeg",
    slug: "karpeg",
  },
  {
    name: "Gaji Berkala",
    slug: "gaji-berkala",
    content: `**Kenaikan Gaji Berkala Bagi PNS di lingkungan Badan Kepegawaian Daerah**  
...
1 (satu) minggu, surat pemberitahuan sudah disampaikan 2 bulan sebelum TMT`,
  },
  {
    name: "CPNS ke PNS",
    slug: "cpns-ke-pns",
    content: `**Pengangkatan CPNS menjadi PNS :**  
...
BKD Prov. Jatim menerbitkan SK pengangkatan CPNS menjadi PNS setelah CPNS yang bersangkutan sudah melaksanakan tugas minimal 1 (satu) tahun dan telah lulus diklat LPJ (Lat. Prajabatan).`,
  },
  {
    name: "Ijin Belajar",
    slug: "ijin-belajar",
    content: `Dasar Ijin Belajar :  **Pergub 71 Tahun 2011**  [(Download)](https://bkd.jatimprov.go.id/layanan/PERGUB_71_2011.pdf)

Lampiran Berkas Izin Belajar  [(Download)](https://bkd.jatimprov.go.id/layanan/IJIN_BELAJAR.rar)
...
9. Surat keterangan dari lembaga pendidikan yang menyatakan bahwa yang bersangkutan diterima/sedang menempuh studi di lembaga tersebut.`,
  ...
  {
    name: "Ujian Kenaikan Pangkat Pembina",
    slug: "ujian-kenaikan-pangkat-pembina",
    content: `
    Dasar Ujian Kenaikan Pangkat Penyetaraan Ijazah :  **Pergub 71 Tahun 2011**  [(Download)](https://bkd.jatimprov.go.id/layanan/PERGUB_71_2011.pdf)

**Pedoman Ujian Kenaikan Pangkat Pembina** [(Download)](https://bkd.jatimprov.go.id/layanan/PEDOMAN_UJIAN_KENAIKAN_PANGKAT_PEMBINA.pdf)

**Lampiran Ujian Kenaikan Pangkat Pembina**  [(Download)](https://bkd.jatimprov.go.id/layanan/Form_UJIAN_SELEKSI_PEMBINA.rar)

**Pedoman Pembuatan Karya Tulis**  [(Download)](https://bkd.jatimprov.go.id/layanan/Form_UJIAN_SELEKSI_PEMBINA.rar)
...
8. Surat Keterangan Sehat Jasmani dan Rohani dari Puskesmas/Rumah Sakit Pemerintah.
  ...
  {
    name: "Ijin Perceraian",
    slug: "ijin-perceraian",
    content: `Mekanisme dan persyaratan permintaan izin perceraian bagi PNS berdasarkan Peraturan Pemerintah Nomor 10 Tahun 1983 Jo Peraturan Pemerintah Nomor 45 Tahun 1990, baik sebagai penggugat atau sebagai tergugat :

**A. Sebagai Pengguga**t (mendapat izin untuk melakukan perceraian) :
...
Semua kelengkapan/persyaratan dimaksud diatas dalam rangkap dua dan apabila berupa foto copy hendaknya dilegalisir oleh pejabat yang berwenang.
  ...
  },
  {
    ...
    content: `**Persyaratan administrasi pengangkatan pertama kali dalam jabatan fungsional:**
...
6. Foto Copy Sah Sertifikat Uji Kompetensi/Diklat (Bagi Fungsional yang dipersyaratkan).`,
  ...
  {
    name: "Penyesuaian Gelar",
    slug: "penyesuaian-gelar",
    content: `**Persyaratan Penyesuaian Gelar**  
1.  Surat Pengantar dari Instansi
2.  SK. pangkat terakhir
3.  SK. Fungsional (jika fungsional)
4.  Surat Keterangan Ijin Belajar
5.  Ijazah
6.  Transkrip
7.  Akreditasi prodi/jurusan
8.  PAK dan gelar yg mau dicantumkan harus sudah dinilaikan di PAKnya (jika fungsional)
9.  Jika ada STILUD PI bisa dilampirkan juga

Mohon untuk dikirim di email  pencantumangelar.bkdjatim@gmail.com`,
  },
];
