/**
 * Query builder helpers for Peremajaan Gelar Akademik proxy with relations and filters
 */
...
const applyProxyPgAkademikFilters = (queryBuilder, filters = {}, opdId) => {
  ...
  if (filters.detail_layanan_nama) {
    query = query.where(
      "siasn_proxy.proxy_pg_akademik.detail_layanan_nama",
      "ilike",
